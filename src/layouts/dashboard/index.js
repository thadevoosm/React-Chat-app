    ...
    <>
      ...
      <Stack sx={{width: 'max-content',}} 
        ...
        :<IconButton onClick={()=>{
         ...
         sx={{width: "max-content", color: theme.palette.mode ==="Light"?'White':theme.palette.text.primary,}} key={ka.index}>{ka.icon}</IconButton>
        ))}
      </Stack>
      ...
      <Divider  sx={{width: '48px', backgroundColorcolor: 'black'}}/>
       ...
       :<IconButton  onClick={()=>{
        setSelected(3);
       }} sx={{width: "max-content", color: theme.palette.mode ==="Light"?'White':theme.palette.text.primary,}}>
        <Gear />
      </IconButton>
      }
      </Stack>
